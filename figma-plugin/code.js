...
(async function main() {
    ...
    try {
      ...
      try {
        await figma.loadFontAsync({
          family: 'Inter',
          style: style === 'Bold' ? 'Bold' : style === 'SemiBold' ? 'Medium' : 'Regular',
        });
        return {
          family: 'Inter',
          style: style === 'Bold' ? 'Bold' : style === 'SemiBold' ? 'Medium' : 'Regular',
  ...
  function buildE1Landing() {
    ...
    const sub = createText(
      "Coming back to work after a career break can feel like starting from zero. It isn't. We turn your resume and life experience into an actionable skill readiness plan.",
      fontSans,
      15.5,
      C.inkSoft
    );
    ...
    heroCard.appendChild(
      createText('A career break counts as experience', fontDispBold, 22, C.ink)
    );
    heroCard.appendChild(
      createText(
        'Caring for family built real skills: budgeting, scheduling, multi-stakeholder coordination. We map them straight to real O*NET workforce competencies.',
        fontSans,
        14,
        C.inkSoft
      )
    ...
    [
      {
        t: '1. Upload your CV',
        d: 'Extract your core career competencies directly from your resume.',
      },
      {
        t: '2. Describe your break',
        d: 'Tell us in your own words what filled your time — AI reframes it to O*NET.',
      },
      {
        t: '3. See fit & top gaps',
        d: 'Get your transparent readiness score and top 3 focus areas.',
      },
    ].forEach((f) => {
  ...
  function buildE2aUploadCV() {
    ...
    card.appendChild(
      createText(
        'We analyze your previous experience to extract your core professional skills automatically.',
        fontSans,
        14,
        C.inkSoft
      )
    ...
    drop.appendChild(
      createText(
        'Drag and drop here, or click to browse · Supports up to 10MB',
        fontSans,
        12.5,
        C.inkFaint
      )
    ...
    selState.paddingLeft = 16;
    selState.paddingRight = 16;
    selState.paddingTop = 12;
    selState.paddingBottom = 12;
    selState.cornerRadius = 12;
    selState.fills = [{ type: 'SOLID', color: C.white }];
    selState.strokes = [{ type: 'SOLID', color: { r: 0.2, g: 0.6, b: 0.4 } }];
    selState.appendChild(
      createText('✓ Sarah_Chen_Resume_2026.pdf (1.8 MB · Verified)', fontSansBold, 13, C.mintText)
    );
  ...
  function buildE2bCareerBreak() {
    ...
    card.appendChild(
      createText(
        'Your time out counts as real experience — just two simple questions for our AI model.',
        fontSans,
        14,
        C.inkSoft
      )
    ...
    q1Box.fills = [];
    q1Box.appendChild(
      createText('1. Roughly how long was your career break?', fontSansBold, 14, C.ink)
    );
    ...
    sliderBar.paddingLeft = 16;
    sliderBar.paddingRight = 16;
    sliderBar.paddingTop = 12;
    sliderBar.paddingBottom = 12;
    ...
    q2Box.fills = [];
    q2Box.appendChild(
      createText('2. What did you do during this time? *', fontSansBold, 14, C.ink)
    );

    const textBox = figma.createFrame();
    textBox.layoutMode = 'VERTICAL';
    textBox.layoutAlign = 'STRETCH';
    textBox.paddingLeft = 16;
    textBox.paddingRight = 16;
    textBox.paddingTop = 14;
    textBox.paddingBottom = 14;
    textBox.cornerRadius = 14;
    textBox.fills = [{ type: 'SOLID', color: C.white }];
    textBox.strokes = [{ type: 'SOLID', color: C.borderSoft }];
    textBox.appendChild(
      createText(
        'Cared for 2 children full-time, managed family household budget and logistics schedules, organized community school fundraisers, and completed self-paced digital design courses.',
        fontSans,
        13.5,
        C.ink
      )
  ...
  function buildE3Snapshot() {
    ...
    titleBox.appendChild(
      createText(
        'Here is the summary of where you are coming from — extracted from your CV & reframed from your break.',
        fontSans,
        14.5,
        C.inkSoft
      )
    ...
    bCard.appendChild(
      createText(
        "Based on your story, you're closest to Senior UX/UI Designer.",
        fontDispBold,
        22,
        C.ink
      )
    ...
    bCard.appendChild(
      createText(
        'This snapshot captures your starting baseline. On this page, we reflect your foundation. Next, you will choose where you want to aim.',
        fontSans,
        13.5,
        C.inkSoft
      )
    ...
    const cb1 = figma.createFrame();
    cb1.layoutMode = 'HORIZONTAL';
    cb1.layoutWrap = 'WRAP';
    cb1.itemSpacing = 8;
    cb1.fills = [];
    [
    ...
    const cb2 = figma.createFrame();
    cb2.layoutMode = 'HORIZONTAL';
    cb2.layoutWrap = 'WRAP';
    cb2.itemSpacing = 8;
    cb2.fills = [];
    [
    ...
    banner.appendChild(
      createText(
        '⚡ NLP Parsing → Active Listening · Time Management · Budgeting · Coordination',
        fontSansBold,
        13,
        C.ink
      )
    ...
    banner.appendChild(
      createText(
        'Your free-form career break text was analyzed and mapped to standard O*NET workforce competency taxonomies.',
        fontSans,
        12,
        C.inkSoft
      )
    ...
    botCTA.appendChild(
      createText(
        'Next: Choose your target role to calculate your custom readiness score and focus areas.',
        fontSansSemi,
        13,
        C.inkSoft
      )
  ...
  function buildE4UxUi() {
    ...
    titleBox.appendChild(
      createText(
        "Pick the role you're aiming for. We started with your closest match — switch to any role you want to aim for.",
        fontSans,
        14.5,
        C.inkSoft
      )
    ...
    m1.appendChild(
      createText('You already have 7 of 10 key skills for this role.', fontSansBold, 13, C.ink)
    );
    ...
    m2.appendChild(
      createText('WHY 78%? IMPORTANCE-WEIGHTED FORMULA', fontSansBold, 10.5, C.pinkDark)
    );
    m2.appendChild(
      createText(
        'Score is weighted by market importance: having foundational essentials (User Research, Prototyping) gives you 78% baseline fit.',
        fontSans,
        12,
        C.inkSoft
      )
    ...
    m3.appendChild(
      createText('78% today → 94% after closing your top 3 focus areas', fontSansBold, 13, C.ink)
    );
    ...
    haveBox.appendChild(
      createText('✓ Skills you already bring (7 matched)', fontSansBold, 13.5, C.ink)
    );
    [
      'User Research & Synthesis',
      'Interactive Prototyping',
      ...
      'Usability Testing',
      'Active Listening (Break)',
      'Time Prioritization (Break)',
    ].forEach((s) => {
    ...
    buildBox.appendChild(
      createText(
        '★ Your top 3 to start with (Capped to avoid overwhelm)',
        fontSansBold,
        13.5,
        C.ink
      )
    ...
    const top3 = [
      {
        name: '1. AI Design Tools (Figma AI, Midjourney)',
        tag: '+9% if learned',
        note: 'Generative asset ideation & rapid exploration workflows',
        type: 'amber',
      },
      {
        name: '2. Scalable Design Systems (Tokens)',
        tag: '+7% if learned',
        note: 'Advanced enterprise variables & multi-brand scaling',
        type: 'amber',
      },
      {
        name: '3. Prompt Engineering for UX Workflows',
        tag: '+5% if learned',
        note: 'Automated micro-copy testing & synthetic user simulation',
        type: 'blue',
      },
    ];
  ...
  figma.notify(
    '✨ ReRouteHer Simplified MVP Flow (CV + 2-Question Break + Snapshot + Gap) generated in Figma!'
  );
  figma.closePlugin();
})();
